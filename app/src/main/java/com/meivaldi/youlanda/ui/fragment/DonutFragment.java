...
public class DonutFragment extends Fragment implements ProductAdapter.ProductAdapterListener {

    private MainActivityViewModel viewModel;
    private FragmentDonutBinding binding;
    private RecyclerView recyclerView;
    private ProductAdapter adapter;
    private List<Product> productList;
    private SearchView searchView;
    private DonutFragmentListener listener;

    public DonutFragment(DonutFragmentListener listener) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_donut, container, false);
    ...
    public void onProductClicked(Product product) {
        ...
        if (stok <= 0) {
            if (product.isSelected()) {
                ...
                listener.onDonutProductClicked(product);
            } else {
    ...
    public interface DonutFragmentListener {
        void onDonutProductClicked(Product product);
    }
